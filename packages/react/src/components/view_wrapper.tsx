...
import { Delegate, Emitter, GenericObject } from '@casium/core';
import { Environment } from '@casium/core/environment';
import { ExternalInterface, InternalContainerDef } from '@casium/core/internal/container';
import Message, { Activate, Constructor, Deactivate, Refresh } from '@casium/core/message';
import ExecContext from '@casium/core/runtime/exec_context';
...
export default class ViewWrapper<M> extends React.Component<ViewWrapperProps<M>, any> {
  ...
  public componentWillMount() {
    ...
    this.unsubscribe = this.execContext.subscribe(pipe(
      this.mergeWithRelay.bind(this),
