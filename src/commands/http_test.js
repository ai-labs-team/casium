...
describe('http', () => {
  ...
  describe('Request.result', () => {
    it('result accepts a Message', () => {
      expect(() => new Request({ method: 'GET', url: '/', result: TestMessage, error: TestMessage })).to.not.throw();
    });

    it('result does not accept a function', () => {
      expect(() => new Request({ method: 'GET', url: '/', result: () => {}, error: TestMessage }))
  ...
  describe('Request.error', () => {
    ...
    it('error does not accept a function', () => {
      expect(() => new Request({ method: 'GET', url: '/', result: TestMessage, error: () => {} }))
