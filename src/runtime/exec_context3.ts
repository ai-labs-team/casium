...
export type ExecContextPartial3 = { state?: (cfg?: object) => object, path?: string[] };

export type ExecContextDef3<M> = {
    env?: Environment.Environment,
    container: Container3<M>,
    parent?: ExecContext3<M> | ExecContextPartial3,
};
 ...
 */
const checkCmdMsgs = curry(<M>(exec: ExecContext3<M>, cmd: Message) => {
 ...
 */
const dispatchAction = <M>(exec: ExecContext3<M>, messageTypes: ReduxMessageMap, action: ReduxAction) => {
...
export default class ExecContext3<M> {
    ...
    public stateManager(): StateManager {
        const parent = this.parent as ExecContext3<M>;
